---
storybook_id: components-footer--docs
title: "Components/Footer"
name: "Docs"
source_url: "https://elements.prod.accelerator.sanofi/?path=/docs/components-footer--docs"
import_path: "./src/components/Footer/Footer.mdx"
capture_tool: opencli browser
capture_status: extracted
captured_at: 2026-06-02T11:08:08.062Z
---

# Source: Components/Footer

- Storybook ID: `components-footer--docs`
- Source URL: https://elements.prod.accelerator.sanofi/?path=/docs/components-footer--docs
- Import path: `./src/components/Footer/Footer.mdx`
- Capture status: `extracted`

# Footer

## The Footer can display your brand's logo, multiple rows and columns of website
links, a copyright notice, and social media profile icons such as Youtube, X,
Facebook, Instagram, and others.You can inject whatever Component as link with the as props on the Footer.Top and
Footer.Bottom links.

## Example

This is a placeholder for additional informations.
...
```
import { Footer, Button, ButtonVariant, ButtonSize, IconName, IconPosition, createToast, Toast, ToastOptions } from "@sanofi-accelerator/elements";

const notify = (args: ToastOptions) => {
  createToast({
    title: "The backToTop props is called.",
    text: "The backToTop props is called.",
    ...
    <>
      ...
      <Footer>
        <Footer.Top
          ...
          additionalInformation="This is a placeholder for additional informations."
          socialLinks={
            <>
              <Footer.SocialLink platform="instagram" href="https://www.instagram.com/" />
              <Footer.SocialLink platform="linkedIn" href="https://www.linkedin.com/" />
              <Footer.SocialLink platform="x" href="https://www.twitter.com/" />
              <Footer.SocialLink platform="tikTok" href="https://www.tiktok.com/" />
              <Footer.SocialLink platform="youTube" href="https://www.youtube.com/" />
              <Footer.SocialLink platform="facebook" href="https://www.facebook.com/" />
            </>
          }
          backToTop={
            <Button
        ...
        >
          <Footer.Column>
            <Footer.TitleLink href="#">Category 1</Footer.TitleLink>
          ...
          <Footer.Column>
            <Footer.TitleLink>Category 2</Footer.TitleLink>
            <Footer.Link href="#">Link 1</Footer.Link>
            <Footer.Link href="#">Link 2</Footer.Link>
            <Footer.Link href="#">Link 3</Footer.Link>
            <Footer.Link href="#">Link 4</Footer.Link>
          ...
          <Footer.Column>
            <Footer.TitleLink>Category 3</Footer.TitleLink>
            <Footer.Link href="#">Link 1</Footer.Link>
            <Footer.Link href="#">Link 2</Footer.Link>
            <Footer.Link href="#">Link 3</Footer.Link>
            <Footer.Link href="#">Link 4</Footer.Link>
          ...
          <Footer.Column>
            <Footer.TitleLink>Category 4</Footer.TitleLink>
            <Footer.Link href="#">Link 1</Footer.Link>
            <Footer.Link href="#">Link 2</Footer.Link>
            <Footer.Link href="#">Link 3</Footer.Link>
            <Footer.Link href="#">Link 4</Footer.Link>
        ...
        <Footer.Bottom legalMention={legalMention}>
          <Footer.BottomLink href="#">Site Map</Footer.BottomLink>
          <Footer.BottomLink href="#">Legal Notice</Footer.BottomLink>
          <Footer.BottomLink href="#">Cookies Policy</Footer.BottomLink>
          <Footer.BottomLink href="#">Privacy & Data Protection</Footer.BottomLink>
          <Footer.BottomLink href="#">Accessibility</Footer.BottomLink>
        </Footer.Bottom>
      </Footer>
    </>
  );
...
| className | Additional CSS classstring | - |
| children | Footer contentReactNode | - |
...
| Name | Description | Default |
| --- | --- | --- |
| brandLogo | The brand logoReactNodeImageProps | - |
| additionalInformation | The additional informationReactNode | - |
| socialLinks | The social linksReactNode | - |
| children | Footer contentReactNode | - |
| backToTop | Back to top buttonReactNode | - |
| classNames | The class names{ top?: string; logoSocial?: string; social?: string \| undefined; logo?: string \| undefined; additionalInformation?: string \| undefined; } \| undefined | - |
| className | Additional CSS classstring | - |
...
| --- | --- | --- |
| children | Footer contentReactNode | - |
| legalMention | The legal mentionReactNode | - |
| brandLogo | The brand logoReactNodeImageProps | - |
| classNames | The class names{ bottom?: string; links?: string; legalMention?: string \| undefined; logo?: string \| undefined; } \| undefined | - |
| className | Additional CSS classstring | - |
| brandTheme | Override the theme at component level"primary""secondary""tertiary" | - |

### Footer.Column

> Inherits from Grid.Item props.
...
| classNames | Custom CSS classes for link elements.({ container?: string; icon?: string; content?: string \| undefined; } & { logoSocial: string; }) \| undefined | - |
...
| variant | Inline variant type."inline": Default color scheme (underlined)"inlineInverse": For dark backgrounds"inline""inlineInverse" | - |
| platform* | Render as another component"medium""facebook""instagram""x""youTube""linkedIn""tikTok""google""apple""snapchat""pinterest""github""threads""whatsApp""figma""messenger"Show 8 more... | - |

### Footer.BottomLink

> Inherits from Typography props.
