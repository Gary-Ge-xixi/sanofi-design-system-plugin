---
storybook_id: components-button--docs
title: "Components/Button"
name: "Docs"
source_url: "https://elements.prod.accelerator.sanofi/?path=/docs/components-button--docs"
import_path: "./src/components/Button/Button.mdx"
capture_tool: opencli browser
capture_status: extracted
captured_at: 2026-06-02T11:05:57.846Z
---

# Source: Components/Button

- Storybook ID: `components-button--docs`
- Source URL: https://elements.prod.accelerator.sanofi/?path=/docs/components-button--docs
- Import path: `./src/components/Button/Button.mdx`
